...
public interface ChangeDetector extends OptionHandler {
    ...
    public void resetLearning();
     ...
     /**
     * Added by Mahmood
     * Retrieve an instance from DDM to a classifier
     * @param Instance
     */
    ...
    /**
     * Added by Mahmood
     * Alarming: reset the window size
     * @param TentitativeAccuracy
     */
    ...
    public boolean ResetWindowSize();
     ...
     /**
     * Added by Mahmood
     * WIndow size to be used for calculating the tentitative accuracy
     * @param TentitativeAccuracy
     */
    ...
    public int WindowSize();
     ...
     /**
     * Added by Mahmood
     * Alarming : Feature selection process has started
     * @param Alarming feature selection
     */
    ...
    /**
     * Added by Mahmood
     * Alarming : Create new instance with feature selection
     * @param Alarming feature selection
     */
    ...
    /**
     * Added by Mahmood
     * Retrieving an array of Summary of selected features as relevant (with 0 value) and irrelevant (with 1 value) to a classifier 
     * @param Retrieving an array
     */
    ...
    /**
     * Added by Mahmood
     * Adding an instance to the change detector<br><br>
     *
     *
     * @param Adding an instance to the change detector
     */
